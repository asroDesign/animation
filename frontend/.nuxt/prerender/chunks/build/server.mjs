import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, defineComponent, computed, unref, ref, h, Suspense, nextTick, mergeProps, provide, Fragment, useSSRContext, withAsyncContext, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'file:///Users/mohammadrassoulzadeh/Documents/project/marktify/front/node_modules/vue/index.mjs';
...
import { getContext, executeAsync } from 'file:///Users/mohammadrassoulzadeh/Documents/project/marktify/front/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///Users/mohammadrassoulzadeh/Documents/project/marktify/front/node_modules/h3/dist/index.mjs';
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, useRoute as useRoute$1, RouterView } from 'file:///Users/mohammadrassoulzadeh/Documents/project/marktify/front/node_modules/vue-router/dist/vue-router.node.mjs';
...
import { defu } from 'file:///Users/mohammadrassoulzadeh/Documents/project/marktify/front/node_modules/defu/dist/defu.mjs';
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from 'file:///Users/mohammadrassoulzadeh/Documents/project/marktify/front/node_modules/ufo/dist/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/mohammadrassoulzadeh/Documents/project/marktify/front/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  ...
  },
  {
    name: "process",
    path: "/process",
    component: () => import('./process.vue.mjs')
  },
  {
    name: "about-us",
    path: "/about-us",
  ...
  },
  {
    name: "our-work",
    path: "/our-work",
    component: () => import('./our-work.vue.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
  ...
  },
  {
    name: "auth-verify",
    path: "/auth/verify",
    component: () => import('./verify.vue.mjs')
  },
  {
    name: "blog-slug",
    path: "/blog/:slug()",
  ...
  },
  {
    name: "our-service",
    path: "/our-service",
    component: () => import('./our-service.vue.mjs')
  },
  {
    name: "auth-register",
    path: "/auth/register",
  ...
  },
  {
    name: "slug-service",
    path: "/:slug()-service",
    component: () => import('./_slug_-service.vue.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
  ...
  },
  {
    ...
    component: () => import('./wallet.vue.mjs')
  },
  {
    name: "portfolio-slug",
    path: "/portfolio/:slug()",
...
const LazyNuxtIcon = defineAsyncComponent(() => import('./nuxt-icon.vue2.mjs').then((r) => r["default"] || r.default || r));
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/tools/Toast.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const Toast = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-4fab7e28"]]);
...
async function callOnce(...args) {
  ...
  (_a = nuxtApp._once)[_key] || (_a[_key] = fn() || true);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    }, { mode: "navigation" }, "$aTUEVnxcOx")), await __temp, __restore();
    useHead({
      link: [
        {
          rel: "preconnect",
      ...
      templateParams: {
        siteName: (_a = websiteConfig.value) == null ? void 0 : _a.site_name,
        separator: "-"
      }
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        class: "bg-gradient-to-r from-[#020617] via-[#1A0A37] to-[#14082A] min-h-screen"
      }, _attrs))}>`);
      _push(ssrRenderComponent(_component_NuxtLayout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(Toast, null, null, _parent2, _scopeId));
...
export { _export_sfc as _, useState as a, useSeoMeta as b, useRuntimeConfig as c, useRoute as d, useRouter as e, useToast as f, useNuxtApp as g, nuxtLinkDefaults as h, asyncDataDefaults as i, createError as j, fetchDefaults as k, useRequestFetch as l, useRequestEvent as m, navigateTo as n, defineNuxtRouteMiddleware as o, callOnce as p, resolveRouteObject as r, server as s, useHead as u };
