...
use App\Http\Controllers\ADMIN\{AdminViewController,ProcessController,
StageController,TicketController,ProjectProcessController,
FormController, AdminController,BlogController,BlogCategoryController,PageController,ProductCategoryController,ProductSubCategoryController,UsersController,VendorController,EmailIntegrationsController,ProductController,SettingController,TestimonialController,DiscountCouponController,OrderController,HomeContentController,MailController,LocaleFileController,WalletController};
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => 'AdminViewAuth'], function () {
        ...
        Route::group(['name'=>'blog.'],function (){
            ...
            Route::resource('category', BlogCategoryController::class)->names([
        ...
        Route::resource('processes',ProjectProcessController::class)->names([
            'index' => 'admin.processes.index',
            'store' => 'admin.processes.store',
            'create' => 'admin.processes.create',
            'edit'   =>'admin.processes.edit',
            'destroy' => 'admin.processes.destroy',
            'show' => 'admin.processes.show',
        ]);

//        Route::get('/processes', [ProjectProcessController::class, 'index'])->name('admin.processes.index');
//        Route::get('/processes/{process}', [ProjectProcessController::class, 'show'])->name('admin.processes.show');
        Route::post('/processes/{process}/stages', [StageController::class, 'store'])->name('admin.stages.store');

        Route::resource('forms', FormController::class)->only(['index', 'create', 'store'])->names([
        ...
        Route::post('/tickets/{ticket}/transfer', [TicketController::class, 'transfer'])->name('admin.tickets.transfer');
        ...
        Route::controller(SettingController::class)->prefix('setting')->group(function(){
            ...
            Route::post('/add_faq',  'faq')->name('admin.setting.faq.store');
