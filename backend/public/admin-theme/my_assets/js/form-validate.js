$(document).ready(function () {
    ...
    $(document)
        ...
        .validate({
            ...
            submitHandler: function (form) {
                var postData =  new FormData(form) //$("#product-sub-category-form").serializeArray();
                add_update_details_with_img("product-sub-category-form", postData);
            },
        });
     ...
     .validate({
      ...
      .validate({
          submitHandler: function (form) {
              ...
              add_update_details("update-product-status-form", postData, 0);
          },
      });
