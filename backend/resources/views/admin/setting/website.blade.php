    ...
    <div class="tp_main_content_wrappo">
        <div class="tp_tab_wrappo">
            <ul>
                ...
                <li><a href="#" class="setting-tab" data-target="faq-settings">FAQ Settings</a></li>
            </ul>
        </div>
        <div class="tp_tab_content">
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="setting-tab-tar" id="faq-settings">
                        <form id="faq-form" action="{{ route('admin.setting.storelongtext') }}" method="POST">
                            @csrf
                            <div class="col-md-12">
                                ...
                                <div id="p-d-body">
                                    @if (@$faq)
                                        @foreach (@$faq['title'] as $key => $val)
                                            <div class="row align-items-center child-items" id="p-field">
                                                <div class="col-md-5">
                                                    <div class="tp_form_wrapper">
                                                        <label class="mb-2">Title</label>
                                                        <input type="text" class="form-control" placeholder="Enter title" name="faq[title][]"
                                                               value="{{ @$val }}" placeholder="Enter title">
                                                    </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="tp_form_wrapper">
                                                        <label class="mb-2">Caption</label>
                                                        <input type="text" class="form-control" placeholder="Enter caption" name="faq[caption][]"
                                                               value="{{ @$faq['caption'][$key] }}" placeholder="Enter caption">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                        ...
                                        <div class="row align-items-center child-items" id="p-field">
                                            ...
                                            <div class="col-md-5">
                                                <div class="tp_form_wrapper">
                                                    ...
                                                    <input type="text" class="form-control" name="faq[caption][]"
                                ...
                                <button type="submit" class="tp_btn" onclick="formValidateFile('faq-form')"
                                        id="footer-form-btn">update</button>
                            </div>
                        </form>
                    </div>
