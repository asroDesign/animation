...
class BlogController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $obj = Blog::firstOrNew(['id'=>$request->id]);
        if(empty($request->id))
        ...
        return response()->json(['status' => true,'msg' =>$msg,'url'=>route('admin.blog.index')], 200);
    }
     /**
     ...
     */
     ...
     {
        return view('admin.blogs.create_or_edit');
     }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.blogs.create_or_edit',compact('data'));
    }
