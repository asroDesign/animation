...
class BlogCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.blogs.category.index',$data);
    }
    ...
    {
        return view('admin.blogs.category.create_or_edit');
    }
    ...
    {
        $rules['name'] = 'required';
        $rules['slug'] = ['required',Rule::unique('blog_categories')->where(function($query) use($request){
        ...
        $obj = BlogCategory::firstOrNew(['id'=>$request->category_id]);
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.blogs.category.create_or_edit',compact('data'));
    }
    ...
    public function categoryView()
    {
        ...
        return view('admin.blogs.category.categoryView');
    }
