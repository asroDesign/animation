...
class CouponsController extends Controller
{
    ...
    public function checkCouponCode(Request $request)
    {
       ...
       //coupon code stored into session
        ...
        \DB::table('carts')->where('user_id',auth()->id())->update([
            'json' => json_encode(array_merge((array)$e,[
                'coupon'=> [
                    'code' => $coupon->coupon_code,
        ...
        return json_response(['status' => true, 'msg' => trans('frontend_msg.coupon_apply_succ'),'discount'=>ceil($discount)], 200);
   ...
   /*  Coupon destroyed */
    public function destroy(){
        ...
        return response()->json(['msg'=>'Coupon has been removed']);
    }
}
